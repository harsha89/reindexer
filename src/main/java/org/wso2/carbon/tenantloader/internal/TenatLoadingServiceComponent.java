...
/**
 * @scr.component name="org.wso2.carbon.tenantloader" immediate="true"
 ...
 * @scr.reference name="tenant.indexloader" interface="org.wso2.carbon.registry.indexing.service.TenantIndexingLoader"
 * cardinality="1..1" policy="dynamic" bind="setIndexLoader" unbind="unsetIndexLoader"
 */
public class TenatLoadingServiceComponent {

    /**
     * Variable used to log entries.
     */
    private static final Log log = LogFactory.getLog(TenatLoadingServiceComponent.class);
    ...
    protected void activate(ComponentContext context) {
        TenantLoader tenantLoader = new TenantLoader();
    ...
    /**
     * Method to set tenant index loader.
     *
     * @param indexLoader tenant index loader
     */
    ...
    /**
     * Method to unset tenant index loader.
     *
     * @param indexLoader tenant index loader
     */
    protected void unsetIndexLoader(TenantIndexingLoader indexLoader) {
        ServiceHolder.unsetIndexLoaderService();
    }
}
